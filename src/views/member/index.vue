  ...
  <div class="h-full bg-zinc-200 dark:bg-zinc-800 duration-400 xl:pt-1">
    ...
    >
      ...
      <div class="py-2 px-1">
        ...
        <div
          class="flex justify-between mt-3 overflow-auto pb-1 scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-700 scrollbar-track-transparent"
        >
          <pay-menu-item-vue
        ...
        <!-- 支付 -->
        <payment-vue class="mt-3" :payData="currentPayData" />
      </div>
    </div>
  </div>
</template>
